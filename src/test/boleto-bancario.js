...
describe('Validar Boletos Bancários', () => {
  ...
  it('validação da linha digitável do boleto válido sem máscara test', () => {
    const result = boletoBancarioLinhaDigitavel('21290001192110001210904475617405975870000002000');
    assert.equal(result, true);
  });
