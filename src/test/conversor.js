...
describe('Converter Boletos', () => {
  ...
  it('test converte linha digitável para código de barras do boleto bancário', () => {
    const result = convertToBoletoBancarioCodigoBarras('21290001192110001210904475617405975870000002000');
    assert.equal(result, '21299758700000020000001121100012100447561740');
  });
